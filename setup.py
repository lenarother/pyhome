...
# -*- coding: utf-8 -*-
"""
    Setup file for pyhome.

    This file was generated with PyScaffold 1.0c2, a tool that easily
...
# Add here console scripts like ['hello_world = pyhome.module:function']
CONSOLE_SCRIPTS = []
...
def setup_package():
    ...
    setup(name=MAIN_PACKAGE,
          ...
          scripts=['bin/crm', 'bin/halfsize', 'bin/mails', 'bin/ok', 'bin/play', 'bin/todo',  'bin/wip', ],
          )
